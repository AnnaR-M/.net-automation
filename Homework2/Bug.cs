...
namespace Homework2
{
...

    {
        ...
        public void FillTestCaseId()
        {
            TestCaseId = int.Parse(Console.ReadLine());
        }

        public void ShowTestCaseId()
        {
            Console.WriteLine(TestCaseId);
        }

        public void FillStepNumber()
        {
        ...
        public void FillExpectedResult()
        {
            ExpectedResult = Console.ReadLine();
        }

        public void ShowExpectedResult()
        {
        ...
        public void ShowBug()
        {
            Console.WriteLine($"id {id}; creationdate {creationDate}; priority {priority}; summary {summary};" +
                $" precondition {precondition}; status {status}; testcaseid {testCaseId}; stepNumber {stepNumber}; " +
                $"actualresult {actualResult}; expectedresutl {expectedResult}");
        }
    }
}
